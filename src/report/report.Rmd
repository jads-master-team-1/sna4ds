...
In order to be able to compare the analysis of both networks it was considered desirable to use the same thresholds on both. Therefore percentage thresholds were identified to be used: above 30% agreement and above 90% agreement. These both relate to the two ranges identified in the descriptive models above and their respective medians.
...
#Plot network
par(mfrow=c(1,2))
network_climate_30perc <- plot_network_perc(edges_climate,0.3,igraph::layout_with_lgl)
hist(igraph::degree(network_climate_30perc), ylim=c(0,600), xlab="Degree", main='Degree distribution with threshold 30%')

par(mfrow=c(1,2))
network_climate_90perc <- plot_network_perc(edges_climate,0.9,igraph::layout_with_graphopt)
hist(igraph::degree(network_climate_90perc), ylim=c(0,600), xlab="Degree", main='Degree distribution with threshold 90%')
```
```{r echo=FALSE}
cn <- c("Measurement", "Value")
nonodes <- c("Number of nodes",igraph::vcount(network_climate_30perc))
noedges <- c("Number of edges",igraph::ecount(network_climate_30perc))
trans <- c("Transitivity", sprintf(igraph::transitivity(network_climate_30perc), fmt = '%#.3f'))
dens <- c("Graph density", sprintf(igraph::edge_density(network_climate_30perc), fmt = '%#.3f'))
avg_path <- c("Average path length", sprintf(igraph::mean_distance(network_climate_30perc), fmt = '%#.3f'))
diam <- c("Diameter", igraph::diameter(network_climate_30perc))
tab <- rbind(cn, nonodes,noedges,trans, dens, avg_path, diam)
rownames(tab) <- NULL
knitr::kable(tab, caption = "Statistics for climate network with threshold 30%")

cn <- c("Measurement", "Value")
nonodes <- c("Number of nodes",igraph::vcount(network_climate_90perc))
noedges <- c("Number of edges",igraph::ecount(network_climate_90perc))
trans <- c("Transitivity", sprintf(igraph::transitivity(network_climate_90perc), fmt = '%#.3f'))
dens <- c("Graph density", sprintf(igraph::edge_density(network_climate_90perc), fmt = '%#.3f'))
avg_path <- c("Average path length", sprintf(igraph::mean_distance(network_climate_90perc), fmt = '%#.3f'))
diam <- c("Diameter", igraph::diameter(network_climate_90perc))
tab <- rbind(cn, nonodes,noedges,trans, dens, avg_path, diam)
rownames(tab) <- NULL
knitr::kable(tab, caption = "Statistics for climate network with threshold 90%")
```
...
#Plot network
par(mfrow=c(1,2))
network_industry_30perc <- plot_network_perc(edges_industry,0.3,igraph::layout_with_lgl)
hist(igraph::degree(network_industry_30perc), ylim=c(0,600), xlab="Degree", main='Degree distribution with threshold 30%')

par(mfrow=c(1,2))
network_industry_90perc <- plot_network_perc(edges_industry,0.9,igraph::layout_with_lgl)
hist(igraph::degree(network_industry_90perc), ylim=c(0,600), xlab="Degree", main='Degree distribution with threshold 90%')
```
```{r echo=FALSE}
cn <- c("Measurement", "Value")
nonodes <- c("Number of nodes",igraph::vcount(network_industry_30perc))
noedges <- c("Number of edges",igraph::ecount(network_industry_30perc))
trans <- c("Transitivity", sprintf(igraph::transitivity(network_industry_30perc), fmt = '%#.3f'))
dens <- c("Graph density", sprintf(igraph::edge_density(network_industry_30perc), fmt = '%#.3f'))
avg_path <- c("Average path length", sprintf(igraph::mean_distance(network_industry_30perc), fmt = '%#.3f'))
diam <- c("Diameter", igraph::diameter(network_industry_30perc))
tab <- rbind(cn, nonodes,noedges,trans, dens, avg_path, diam)
rownames(tab) <- NULL
knitr::kable(tab, caption = "Statistics for industry network with threshold 30%")

cn <- c("Measurement", "Value")
nonodes <- c("Number of nodes",igraph::vcount(network_industry_90perc))
noedges <- c("Number of edges",igraph::ecount(network_industry_90perc))
trans <- c("Transitivity", sprintf(igraph::transitivity(network_industry_90perc), fmt = '%#.3f'))
dens <- c("Graph density", sprintf(igraph::edge_density(network_industry_90perc), fmt = '%#.3f'))
avg_path <- c("Average path length", sprintf(igraph::mean_distance(network_industry_90perc), fmt = '%#.3f'))
diam <- c("Diameter", igraph::diameter(network_industry_90perc))
tab <- rbind(cn, nonodes,noedges,trans, dens, avg_path, diam)
rownames(tab) <- NULL
knitr::kable(tab, caption = "Statistics for industry network with threshold 90%")
```
