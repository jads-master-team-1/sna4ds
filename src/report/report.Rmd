...
Based on literature research and available statistical tools, the following research questions and hypotheses will be answered using the self-provided dataset.

<!--
correct to add "and industry bill" in question 1 @laurens ?
is this order respected @laurens ? "ERGM then QAP question"
-->
1- “What is the correlation between the network from the climate bill and the network from the industry bill?”
2- “What is the cohesion of agreement, based on the climate and industry bill, within every European group?”
...
	“We expect a high level of cohesion”. 
	“We expect a high level of correlation”. 
<!--
not sure if this following part is supposed to be here or not @laurens ?
-->
